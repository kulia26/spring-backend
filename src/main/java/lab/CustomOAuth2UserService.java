...
import lab.security.OAuth2UserInfo;
import lab.security.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
  ...
  private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) throws OAuth2AuthenticationProcessingException {
    ...
    Optional<User> userOptional = userRepository.findByPhone(oAuth2UserInfo.getEmail());
    User user;
  ...
  private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
    ...
    user.setPhone(oAuth2UserInfo.getEmail());
